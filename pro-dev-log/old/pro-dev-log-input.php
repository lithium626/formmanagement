		...
		<div class="container">
			...
			<div class="content">
				<?php
					...
					$query = "INSERT INTO prodevlog (employee, academic_year, supervisor, workshop_1, workshop_1_hours, workshop_2, workshop_2_hours, workshop_3, workshop_3_hours, workshop_4, workshop_4_hours, workshop_5, workshop_5_hours, workshop_6, workshop_6_hours, workshop_7, workshop_7_hours, workshop_8, workshop_8_hours, workshop_9, workshop_9_hours, workshop_10, workshop_10_hours, workshop_11, workshop_11_hours, workshop_12, workshop_12_hours, workshop_13, workshop_13_hours, workshop_14, workshop_14_hours, workshop_15, workshop_15_hours, requirement_met, reason_not_met, employee_signature, employee_date, supervisor_signature, supervisor_date) VALUES ('$employee', '$academic_year', '$supervisor', '$workshop_1', '$workshop_1_hours', '$workshop_2', '$workshop_2_hours', '$workshop_3', '$workshop_3_hours', '$workshop_4', '$workshop_4_hours', '$workshop_5', '$workshop_5_hours', '$workshop_6', '$workshop_6_hours', '$workshop_7', '$workshop_7_hours', '$workshop_8', '$workshop_8_hours', '$workshop_9', '$workshop_9_hours', '$workshop_10', '$workshop_10_hours', '$workshop_11', '$workshop_11_hours', '$workshop_12', '$workshop_12_hours', '$workshop_13', '$workshop_13_hours', '$workshop_14', '$workshop_14_hours', '$workshop_15', '$workshop_15_hours', '$requirement_met', '$reason_not_met', '$employee_signature', '$employee_date', '$supervisor_signature', '$supervisor_date')";
					$result = mysqli_query($dbc, $query) or die ('Error inserting data into database.<br>' . mysqli_error($dbc));
					mysqli_close($dbc);
					
					$to = "$supervisor";
					$subject = "Professional Development Log - Submitted";
					$msg = "$employee submitted their Professional Development Log.";
					mail($to, $subject, $msg);
				?>
