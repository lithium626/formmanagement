	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<form method="POST" name="pro-dev-log-choose" action="pro-dev-log-edit.php">
					<?php
						include("../dbconnect.php");
						$query = "SELECT * FROM prodevlog ORDER BY ID DESC";
						$result = mysqli_query($dbc, $query) or die ('Error querying database: ' . mysqli_error($dbc));
						print("<div style='text-align:center;'><select name='pro_dev_log_ID'>");
					...
					<div align="center"><input type="submit" value="Edit Pro. Dev. Log"></div>
					<div id="biglinebreak"></div>
