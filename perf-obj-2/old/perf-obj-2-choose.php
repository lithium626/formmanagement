		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Choose a Progress Conference #2 to edit.
				</p>
				<form method="POST" name="perf-obj-2-choose" action="perf-obj-2-edit.php">
					<?php
						include("../dbconnect.php");
						$query = "SELECT * FROM perfobj2 ORDER BY ID";
					...
					<div align="center"><input type="submit" value="Edit Conference #2"></div>
					<div id="biglinebreak"></div>
