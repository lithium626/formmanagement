...
<html>
	...
	<body>
		<?php
			...
			$query = "SELECT * FROM perfobj2 WHERE supervisor LIKE '%$search%'";
		...
		<div class="container">
			...
			<div class="content">
				...
				<h2>Sampson Community College<br><br>Performance Objective #2</h2>
				...
				<?php
					...
					if($num_rows > 0)
					{
						...
						{								
							print("<form method='POST' name='perf-obj-2-choose' action='perf-obj-2-print.php'>");
