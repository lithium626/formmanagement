	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<div align="center">
					<form>
						<input type="button" value="Choose Objective to Edit" onClick="window.location='perf-obj-2-choose.php'">
						<input type="button" value="Choose Objective to Print" onClick="window.location='perf-obj-2-choose-print.php'">
					</form>
				</div>
				...
				<div id="biglinebreak">&nbsp;</div>
				<form name="perf-obj-2-input" action="perf-obj-2-input.php" method="POST" autocomplete="on" enctype="multipart/form-data">
