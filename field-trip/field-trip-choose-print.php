		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Search by employee's last name or field trip date (yyyy-mm-dd):
				</p>
				<form method="GET" name="field-trip-search" action="field-trip-search.php" style="text-align:center;">
				...
				<p style="text-align:center;">
					Choose a field trip stored in the archives to print.
				</p>
				<form method="POST" name="field-trip-choose" action="field-trip-print.php">
					<?php
						...
						print("<div style='text-align:center;'><select name='field_trip'>");
					...
					<div align="center"><input type="submit" value="Print Field Trip"></div>
					<div id="biglinebreak"></div>
