		...
		<div class="container">
			...
			<div class="content">
				...
				<form name="makeup-plan-edit" action="makeup-plan-edit-input.php" method="POST" autocomplete="on">
					...
					<input name="additional_date" id="datePick" type="text" value="<?php echo ($row['8']); ?>"/>
						<script>
					...
					<input id="filename" type="text" name="additional_form" value="<?php echo ($row['21']); ?>">
					</div>
					...
					<input id="checkbox" type="radio" name="cancellation_cause" value="family_illness" <?php if($row['22']=='family_illness') { print('checked'); } else { print(''); } ?>> Family Illness/Death &nbsp; &nbsp;<br><br><br>
