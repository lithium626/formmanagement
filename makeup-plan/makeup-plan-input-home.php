...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/multidatespicker.js"/></script>
	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<form name="makeup_plan_input" action="makeup-plan-input.php" method="POST" autocomplete="on" enctype="multipart/form-data">
					...
					<input name="additional_date" id="datePick" type="text" placeholder="Date(s) Time Added - Select Multiple">
						<script>
							$('#datePick').multiDatesPicker();
						</script>
					<!--<input  type="date" name="additional_date">-->
					<input type="number" min="0" step="0.25" name="additional_met" placeholder="Additional Time Met (hrs) per Date" onfocus="this.placeholder = ''" onblur="this.placeholder='Additional Time Met (hrs) per Date'">
