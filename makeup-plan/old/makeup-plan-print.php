		...
		<div class="container">
			...
			<div class="content">
				...
				<form name="makeup-plan-edit" action="makeup-plan-edit-input.php" method="POST" autocomplete="on">
					...
					<input id="checkbox" type="radio" name="cancellation_cause" value="family_illness" <?php if($row['21']=='family_illness') { print('checked'); } else { print(''); } ?>> Family Illness/Death &nbsp; &nbsp;<br><br>
