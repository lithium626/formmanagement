		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Search by date (yyyy-mm-dd), course prefix, or instructor's last name:
				</p>
				<form method="GET" name="makeup-plan-search" action="makeup-plan-search.php" style="text-align:center;">
					<input type="text" name="search" autofocus>
					<input type="submit" value="Begin Search...">
				</form>
				<br><br><br>
				<p style="text-align:center;">
					Choose a makeup plan stored in the archives to print.
				</p>
				<form method="POST" name="makeup-plan-choose" action="makeup-plan-print.php">
					<?php
						include("../dbconnect.php");
						$query = "SELECT * FROM makeupplan ORDER BY ID DESC";
						$result = mysqli_query($dbc, $query) or die ('Error querying database: ' . mysqli_error($dbc));
						print("<div style='text-align:center;'><select name='makeup_plan'>");
					...
					<div align="center"><input type="submit" value="Print Makeup Plan"></div>
					<div id="biglinebreak"></div>
