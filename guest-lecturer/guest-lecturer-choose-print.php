		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Search by course date (yyyy-mm-dd), course prefix, or instructor's last name:
				</p>
				<form method="GET" name="guest-lecturer-search" action="guest-lecturer-search.php" style="text-align:center;">
