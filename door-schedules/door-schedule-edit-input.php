		...
		<div class="container">
			...
			<div class="content">
				<?php
					...
					//$query = "UPDATE doorschedule SET instructor='$instructor', employee_email='$employee_email', semester='$semester', supervisor='$supervisor', schedule_form='$schedule_form', instructor_signature='$instructor_signature', instructor_date='$instructor_date', chair_signature='$chair_signature', chair_date='$chair_date', vp_signature='$vp_signature', vp_date='$vp_date' WHERE ID='$id'";
					$query = "UPDATE doorschedule SET instructor='$instructor', employee_email='$employee_email', semester='$semester', supervisor='$supervisor', instructor_signature='$instructor_signature', instructor_date='$instructor_date', chair_signature='$chair_signature', chair_date='$chair_date', vp_signature='$vp_signature', vp_date='$vp_date' WHERE ID='$id'";
					...
					{
						$to = "$employee_email";
						$subject = "Faculty / Staff Semester Door Schedule - Approved";
						$msg = "The Faculty / Staff Semester Door Schedule for $instructor ($semester semester) has been signed and approved.  It is available for print from your Division Secretary.";
						mail($to, $subject, $msg);
					}
				?>
				<h2>Faculty / Staff Semester Door Schedule</h2>
				<p>Thank you for editing the Faculty / Staff Semester Door Schedule.  The information will be stored in a database for final approval and archival.</p>
			</div>
		</div>
	</body>
</html>