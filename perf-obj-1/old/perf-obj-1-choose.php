		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Choose a Performance Objective #1 to edit.
				</p>
				<form method="POST" name="perf-obj-1-choose" action="perf-obj-1-edit.php">
					<?php
						include("../dbconnect.php");
						$query = "SELECT * FROM perfobj1 ORDER BY ID";
					...
					<div align="center"><input type="submit" value="Edit Objective #1"></div>
					<div id="biglinebreak"></div>
