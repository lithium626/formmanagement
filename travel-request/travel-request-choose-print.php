	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<form method="GET" name="travel-request-search" action="travel-request-search.php" style="text-align:center;">
				...
				<form method="POST" name="travel-request-choose" action="travel-request-print.php">
					<?php
						...
						print("<div style='text-align:center;'><select name='travel_request'>");
					...
					<div align="center"><input type="submit" value="Print Travel Request"></div>
					<div id="biglinebreak"></div>
