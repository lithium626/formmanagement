	...
	<body>
		...
		<div class="container">
			...
			<div class="content">
				...
				<div id="printbutton" align="center"><input type="submit" style="width:200px;height:50px;margin-bottom:20px;" value="Print Travel Request" onClick="window.print()"></div>
				...
				<form name="travel-request-edit" action="travel-request-edit-input.php" method="POST" autocomplete="on" enctype="multipart/form-data">
					...
					<?php print("<a target='_blank' href='http://forms.sampsoncc.edu/tr-forms/" . $row['19'] . "'>");
						echo ($row['19']);
						print("</a>");
					?>
