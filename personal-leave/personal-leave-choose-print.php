		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Search by employee's last name or personal leave data requested (yyyy-mm-dd):
				</p>
				<form method="GET" name="personal-leave-search" action="personal-leave-search.php" style="text-align:center;">
