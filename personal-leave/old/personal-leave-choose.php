	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<form method="POST" name="personal-leave-choose" action="personal-leave-edit.php">
					<?php
						include("../dbconnect.php");
						$query = "SELECT * FROM personalleave ORDER BY ID";
						$result = mysqli_query($dbc, $query) or die ('Error querying database: ' . mysqli_error($dbc));
						print("<div style='text-align:center;'><select name='personal_leave_ID'>");
