			...
			<div class="content">
				...
				<form name="sick-leave-input" action="sick-leave-input.php" method="POST" autocomplete="on">
					...
					<blockquote style="text-align:center;">
						...
						<input type="number" min="0" step="0.1" name="total_hours_before" placeholder="Total Hours Before Multiplier" onfocus="this.placeholder=''" onblur="this.placeholder='Total Hours Before Multiplier"><br><br><br>
					</blockquote>
					
					<span id="label">TOTAL HOURS <mark>w/ MULTIPLIER:</mark></span>
					<input type="number" min="0" step="0.1" name="sl_total_time" placeholder="Total Hours" onfocus="this.placeholder=''" onblur="this.placeholder='Total Hours'">
