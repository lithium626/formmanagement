	...
	<body>
		...
		<div class="container">
			...
			<div class="content">
				...
				<form name="sick-leave-edit" action="sick-leave-edit-input.php" method="POST" autocomplete="on">
					...
					<input type="text" name="al_total_time" value="<?php echo ($row['23']); ?>"><br><br><br>
					</div>
					...
					<span id="label">TOTAL HOURS:</span>
					<input type="text" name="bl_total_time" value="<?php echo ($row['30']); ?>"><br><br><br>
					</div>
					...
					<input type="text" name="fl_relationship" value="<?php echo ($row['38']); ?>"><br><br><br>
					</div>
					...
					<blockquote style="text-align:center;">
						<span id="label">For more than 2 dates of absence, enter the total number<br> of hours missed <mark>(before multiplier)</mark>: </span>
						<input type="number" min="0" step="0.1" name="total_hours_before" value="<?php echo ($row['45']); ?>"><br><br><br>
					</blockquote>
					
					<span id="label">TOTAL HOURS <mark>w/ MULTIPLIER:</mark></span>
					<input type="text" name="sl_total_time" value="<?php echo ($row['46']); ?>">
					<span style="font-size: 13px;">***Faculty Enter Multiplier Used:</span> <input type="number" min="0" step="0.1" name="sl_multiplier" value="<?php echo ($row['47']); ?>"><br><br><br>
					<span id="label">Type of sick leave taken:</span><br><br>
					Personal / Family &nbsp; <input id="checkbox" type="radio" name="sl_type" value="personal-family" <?php if($row['48']=='personal-family') { print('checked'); } else { print(''); } ?>> &nbsp; 
					Maternity &nbsp; <input id="checkbox" type="radio" name="sl_type" value="maternity" <?php if($row['48']=='maternity') { print('checked'); } else { print(''); } ?>><br><br><br>
					</div>
					...
					Applicant's Signature: <input id="signature" type="text" name="applicant_signature" value="<?php echo ($row['49']); ?>" required>
					Date: <input type="date" name="applicant_date" value="<?php echo ($row['50']); ?>"><br><br><br>
					
					Dept./Div. Chair's Signature: <input id="signature" type="text" name="chair_signature" value="<?php echo ($row['51']); ?>">
					Date: <input type="date" name="chair_date" value="<?php echo ($row['52']); ?>"><br><br><br>
					
					VP of Academic Affair's Signature: <input id="signature" type="text" name="vp_signature" value="<?php echo ($row['53']); ?>">
					Date: <input type="date" name="vp_date" value="<?php echo ($row['54']); ?>"><br><br><br>
