			...
			<div class="content">
				<?php
					...
					if($vp_signature == '')
					{
						...
						$to = "vlucas@sampsoncc.edu, kjackson@sampsoncc.edu, ksadvary@sampsoncc.edu";
						$subject = "Employee Leave Form - Submitted";
