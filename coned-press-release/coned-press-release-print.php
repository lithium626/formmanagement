	...
	<body>
		...
		<div class="container">
			...
			<div class="content">
				...
				<div id="printbutton" align="center"><input type="submit" style="width:200px;height:50px;margin-bottom:20px;" value="Print ConEd Press Release" onClick="window.print()"></div>
