		...
		<div class="container">
			...
			<div class="content">
				...
				<p style="text-align:center;">
					Search by start date (yyyy-mm-dd) or course instructor's last name:
				</p>
				<form method="GET" name="coned-press-release-search" action="coned-press-release-search.php" style="text-align:center;">
				...
				<p style="text-align:center;">
					Choose a ConEd Press &amp; Information Release Form stored in the archives to print.
				</p>
				<form method="POST" name="coned-press-release-choose" action="coned-press-release-print.php">
					<?php
					...
					<div align="center"><input type="submit" value="Print ConEd Press Release Form"></div>
					<div id="biglinebreak"></div>
